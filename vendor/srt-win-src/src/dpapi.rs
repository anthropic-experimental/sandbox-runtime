...
//!
//! Used to encrypt the sandbox user's password at rest in the
//! state store (machine store: the `cred.dat` file; legacy
//! per-user store: the `sandbox_user.cred` DB column).
//!
