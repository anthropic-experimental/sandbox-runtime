      ...
      caCertPath: z
        ...
        .describe(
          'Path to a PEM-encoded CA certificate. The sandboxed child is ' +
            ...
            'generates-if-absent a persistent CA under the state ' +
            "directory's ca\\ subdir (machine-wide " +
            '%ProgramData%\\sandbox-runtime when provisioned, else ' +
            'per-user %LOCALAPPDATA%\\sandbox-runtime) and trusts it in the ' +
